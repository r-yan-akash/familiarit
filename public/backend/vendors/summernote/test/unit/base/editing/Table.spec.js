...
describe('base:editing.Table', () => {
  ...
  describe('tableWorker', () => {
    ...
    it('should delete simple 1x1 table', () => {
      var $cont = $('<div class="note-editable"><table><tr><td>contact</td></tr></table></div>');
    ...
    it('should add simple row to table on top', () => {
      ...
      expect('<table><tbody><tr><td><br></td></tr><tr><td>contact</td></tr></tbody></table>').to.equalsIgnoreCase($cont.html());
    });
    ...
    it('should add simple row to table on bottom', () => {
      ...
      expect('<table><tbody><tr><td>contact</td></tr><tr><td><br></td></tr></tbody></table>').to.equalsIgnoreCase($cont.html());
    });
