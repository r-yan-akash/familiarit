(function ($) {
    ...
    FlotTooltip.prototype.init = function (plot) {
        ...
        plot.showTooltip = function (target, position, targetPosition) {
            ...
            // convert tooltip contact template to real tipText
    ...
    /**
     * core function, create tooltip contact
     * @param  {string} content - template with tooltip contact
     * @param  {object} item - Flot item
     * @return {string} real tooltip contact for current item
     */
	...
	// for CurvedLines plugin we need to read data from different place
        ...
        // if it is a function callback get the contact string
        if (typeof(content) === 'function') {
            content = content(item.series.label, x, y, item);
        }

        // the case where the passed contact is equal to false
    ...
    FlotTooltip.prototype.adjustValPrecision = function (pattern, content, value) {
        ...
        if( matchResult !== null ) {
            if(RegExp.$1 !== '') {
                ...
                // only replace contact if precision exists, in other case use thickformater
