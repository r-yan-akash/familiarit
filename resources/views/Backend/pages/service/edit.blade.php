    ...
    <div class="ibox-body">
        <form class="form-horizontal" action="{{route('services.update',$service->id)}}" method="post"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" value="{!! $service->icon !!}" name="icon">
                    @error('icon')
                    <div class="form-control-feedback">{{$message}}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea name="description"  maxlength="300" id="editor1" rows="4" placeholder="Description..." class="form-control">
                        {!! $service->description !!}"
                    </textarea>
