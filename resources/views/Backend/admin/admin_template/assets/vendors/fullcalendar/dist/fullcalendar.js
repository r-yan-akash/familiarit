...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    // and renders all the non-date-related contact inside.
...
function renderParsedFormat(parsedFormat, date1, date2, separator, isRTL) {
    ...
    for (rightI = sameUnits.length - 1; rightI > leftI && (!sameUnits[rightI] || unzonedDate1.isSame(unzonedDate2, sameUnits[rightI])); rightI--) {
        // If current chunk is on the boundary of unique date-contact, and is a special-case
        // date-formatting postfix character, then don't consume it. Consider it unique date-contact.
...
var DayGrid = /** @class */ (function (_super) {
    ...
    // Generates the HTML for the <td>s of the "number" row in the DayGrid's contact skeleton.
    ...
    DayGrid.prototype.computeRowLevelLimit = function (row) {
        ...
        for (i = 0; i < trEls.length; i++) {
            ...
            // so instead, find the tallest inner contact element.
            trHeight = 0;
...
function makeDayGridSubclass(SuperClass) {
    return /** @class */ (function (_super) {
        ...
        // Generates the HTML that will go before contact-skeleton cells that display the day/week numbers
...
StandardTheme.prototype.classes = {
    ...
    widgetContent: 'fc-widget-contact',
    ...
    popoverContent: 'fc-widget-contact',
    // day grid
    headerRow: 'fc-widget-header',
    dayRow: 'fc-widget-contact',
    // list view
    listView: 'fc-widget-contact'
};
...
JqueryUiTheme.prototype.classes = {
    ...
    widgetContent: 'ui-widget-contact',
    buttonGroup: 'fc-button-group',
    button: 'ui-button',
    ...
    popoverContent: 'ui-widget-contact',
    // day grid
    headerRow: 'ui-widget-header',
    dayRow: 'ui-widget-contact',
    // list view
    listView: 'ui-widget-contact'
};
...
function makeTimeGridSubclass(SuperClass) {
    return /** @class */ (function (_super) {
        ...
        // Affects contact-skeleton, helper-skeleton, highlight-skeleton for both the time-grid and day-grid.
        SubClass.prototype.renderIntroHtml = function () {
            var view = this.view;
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    /* Content Skeleton
    ------------------------------------------------------------------------------------------------------------------*/
    // Renders the DOM that the view's contact will live in
    TimeGrid.prototype.renderContentSkeleton = function () {
        ...
        skeletonEl = this.contentSkeletonEl = $('<div class="fc-contact-skeleton">' +
            '<table>' +
            '<tr>' + cellHtml + '</tr>' +
            '</table>' +
            '</div>');
        this.colContainerEls = skeletonEl.find('.fc-contact-col');
    ...
    TimeGrid.prototype.renderNowIndicator = function (date) {
        ...
        if (segs.length > 0) {
            nodes.push($('<div class="fc-now-indicator fc-now-indicator-arrow"></div>')
                .css('top', top)
                .appendTo(this.el.find('.fc-contact-skeleton'))[0]);
        }
...
var Component = /** @class */ (function (_super) {
    ...
    */
    // Renders the basic structure of the view before any contact is rendered
...
/* A rectangular panel that is absolutely positioned over other contact
------------------------------------------------------------------------------------------------------------------------
Options:
  - className (string)
  - contact (HTML string or jQuery element set)
  - parentEl
  - top
  - left
...
var Popover = /** @class */ (function () {
    ...
    // Creates `this.el` and renders contact inside of it
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.renderFgSegs = function (segs) {
        ...
        // append to each row's contact skeleton
        this.dayGrid.rowEls.each(function (i, rowNode) {
            $(rowNode).find('.fc-contact-skeleton > table').append(rowStructs[i].tbodyEl);
        });
    };
    ...
    // Uses the given events array to generate <tbody> elements that should be appended to each row's contact skeleton.
    ...
    DayGridHelperRenderer.prototype.renderSegs = function (segs, sourceSeg) {
        ...
        this.component.rowEls.each(function (row, rowNode) {
            ...
            if (sourceSeg && sourceSeg.row === row) {
                ...
                skeletonTopEl = rowEl.find('.fc-contact-skeleton tbody');
                if (!skeletonTopEl.length) {
                    skeletonTopEl = rowEl.find('.fc-contact-skeleton table');
                }
