...
var TooltipUI = /** @class */ (function () {
    function TooltipUI($node, options) {
        ...
        this.$tooltip = $([
            ...
            '  <div class="note-tooltip-contact"/>',
            '</div>'
        ].join(''));
        // define event
    ...
    TooltipUI.prototype.show = function () {
        ...
        $tooltip.addClass('in');
        $tooltip.find('.note-tooltip-contact').text(title);
...
var popover = renderer.create([
    ...
    '  <div class="note-popover-contact note-children-container"/>',
    '</div>'
...
var ui = {
    ...
    /**
     * get popover contact area
     *
     * @param $popover
     * @returns {*}
     */
    getPopoverContent: function ($popover) {
        return $popover.find('.note-popover-contact');
    },
    /**
    ...
    Typing.prototype.insertParagraph = function (editable) {
        ...
        if (splitRoot) {
            ...
            if (dom.isEmpty(splitRoot) && dom.isLi(splitRoot)) {
                ...
                nextPara = splitRoot;
                // if new line has contact (not a line break)
            }
            else {
...
var Dropzone = /** @class */ (function () {
    ...
    Dropzone.prototype.attachDragAndDropEvent = function () {
        ...
        this.$dropzone.on('drop', function (event) {
            ...
            // stop the browser from opening the dropped contact
            event.preventDefault();
...
var LinkPopover = /** @class */ (function () {
    ...
    LinkPopover.prototype.initialize = function () {
        this.$popover = this.ui.popover({
            ...
            callback: function ($node) {
                var $content = $node.find('.popover-contact,.note-popover-contact');
                $content.prepend('<span><a target="_blank"></a>&nbsp;</span>');
            }
        }).render().appendTo(this.options.container);
        var $content = this.$popover.find('.popover-contact,.note-popover-contact');
...
var AirPopover = /** @class */ (function () {
    ...
    AirPopover.prototype.initialize = function () {
        ...
        var $content = this.$popover.find('.popover-contact');
...
var HintPopover = /** @class */ (function () {
    ...
    HintPopover.prototype.initialize = function () {
        ...
        this.$popover.hide();
        this.$content = this.$popover.find('.popover-contact,.note-popover-contact');
